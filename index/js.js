...
stockProductos.forEach((producto) => {
    ...
    div.innerHTML = `
    <figure>
    <a href=${producto.href}><img src=${producto.img}></a>
    </figure>
    ...
    //le hstockProductosago un get element by id (el de agregar) Obtengo el elemento y a dicho elemento le agregamos
